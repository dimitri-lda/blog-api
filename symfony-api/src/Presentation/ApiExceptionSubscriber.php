...
final class ApiExceptionSubscriber
{
    ...
    public function __invoke(ExceptionEvent $event): void
    {
        ...
        $message = $status >= 500 && !$this->debug ? 'An unexpected error occurred.' : $error->getMessage();
        $event->setResponse(new JsonResponse(['message' => $message, 'errors' => new stdClass()], $status));
    }
}
