...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $products = [
            ...
            ['category'=>'fitness','name'=>'Move Training Mat','brand'=>'Sportivo','slug'=>'move-training-mat','price_cents'=>4900,'description'=>'A grippy, comfortable mat for your home and studio practice.','image_url'=>'https://images.unsplash.com/photo-1592432678016-e910b452f9a2?auto=format&fit=crop&w=900&q=85','featured'=>true],
            ['category'=>'tennis','name'=>'Pure Aero 98','brand'=>'Babolat','slug'=>'pure-aero-98','price_cents'=>22900,'description'=>'Spin, precision and feel for the player who controls every point.','image_url'=>'https://images.unsplash.com/photo-1617083934555-5f3e4f6b9c4b?auto=format&fit=crop&w=900&q=85','featured'=>true],
            ...
            ['category'=>'fitness','name'=>'Kettlebell 12kg','brand'=>'Sportivo','slug'=>'kettlebell-12kg','price_cents'=>5900,'description'=>'A durable cast iron kettlebell for full-body strength sessions.','image_url'=>'https://images.unsplash.com/photo-1517963879433-6ad2b056d712?auto=format&fit=crop&w=900&q=85','featured'=>false],
